      ...
      <div class="container padding-bottom-3x mb-2">
        <div class="row justify-content-center">
          <div class="col-lg-8 col-md-10">
            ...
            <p>Verify you account here</p>
            <ol class="list-unstyled">
              <li><span class="text-primary text-medium">1. </span>We have send a 8-digit code on your mobile phone.</li>
              <li><span class="text-primary text-medium">2. </span>Use the code to verify your account.</li>
              <li><span class="text-primary text-medium">3. </span>Please insert the given code below.</li>
            </ol>
            <form class="card mt-4" method="post">
              <div class="card-body">
                <div class="form-group">
                  <label for="email-for-pass">Enter your 8-digit Code</label>
			  ...
			  <?php 
							if(isset($_REQUEST['verify']))
							{
								...
								{
									echo "<script>window.location.replace('account-signup2.php?id=$uid')</script>";
								}
								else
								{
									echo "<script>alert('Invalid code! please enter the correct code.')</script>";
