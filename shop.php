        ...
        <div class="shop-toolbar padding-bottom-1x mb-2">
          <div class="column">
            <div class="shop-sorting">
              ...
              </select><span class="text-muted">Products Available:&nbsp;</span><span>(<?php	$query = "SELECT p_id FROM product"; 
        ...
        <div class="isotope-grid cols-4 mb-2">
          ...
          <div class="grid-item">
            <div class="product-card">
				...
				<a class="product-thumb" href="product.php?id=<?php echo $r['p_id'] ?>"><img src="<?php echo 'data:image/jpeg;base64,'. base64_encode($r['image']); ?>" alt="Product"></a>
